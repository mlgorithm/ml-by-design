...
$x_i$ & The $i$-th example (row of $X$) & Bridge~I \\
...
$\lambda$ & Regularization strength & Bridge~I, Ch.~\ref{ch:linear-models} \\
...
Hinge loss & $\max(0,\, 1 - y\,(w^\top x + b))$ & Ch.~\ref{ch:linear-models} \\
