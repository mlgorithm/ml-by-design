...
\midrule
Conditional probability and Bayes' rule & Chapters 1, 8 (framing, language grounding) \\
Loss functions and scoring rules & Chapters 2, 5 (metrics, neural training) \\
Empirical vs.\ population risk & Chapters 2b, 10 (evaluation, experiments) \\
Gradient descent & Chapter 5 (optimization, backpropagation) \\
Cost-sensitive thresholds & Chapters 2, 7 (decision rules, detection) \\
\bottomrule
\end{tabular}
\end{table}
