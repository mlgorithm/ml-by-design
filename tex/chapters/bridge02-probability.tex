...
\item Treat the functional view of predictors and risks as second-pass vocabulary: useful for later chapters, but not required before continuing.
\item Read gradients and the chain rule as credit-assignment tools for reducing training loss.
\item Distinguish generative and discriminative models at an intuitive level; treat priors and MAP as preview vocabulary for later probabilistic chapters.
\end{learninggoals}
