...
\begin{practicalnote}
This chapter focuses on binary classification metrics. When the task has more than two classes, metrics such as macro-averaged and micro-averaged F1 become important. Chapter~9 returns to multi-class evaluation; for now, the binary case illustrates all the key principles.
\end{practicalnote}
