...
The sum of squares rose from \(8\) to \(11\) when we moved away from the mean. Any other constant will produce a sum of squares no smaller than \(8\). The mean is the projection of the data onto the constant-model class: it is the unique member of that class that sits closest to the data under squared error.
