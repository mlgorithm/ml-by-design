...
\begin{learninggoals}
\item Separate a vague institutional ambition from a defensible learning problem.
\item Distinguish prediction, decision, proxy target, label rule, and downstream action.
\item Treat datasets as evidence produced by a process rather than as direct truth.
\item Use the Five Commitments to state the task, data, representation, objective, and evaluation preview.
\item Write a framing memo that makes later modeling work testable and defensible.
\end{learninggoals}
