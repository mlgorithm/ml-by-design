...
This chapter framed the problem: what is the task, what is the proxy, and what counts as a defensible learning problem? The next two chapters make that memo judgeable. Chapter 2 asks what predictive behavior counts as good for the decision in front of us. Chapter 3 then asks how to protect that judgment from leakage, weak baselines, and accidental misuse of held-out evidence. In other words, Chapter 1 writes the claim in operational form; Chapters 2 and 3 test whether the later evidence deserves to support it.
