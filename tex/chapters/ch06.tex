...
\begin{practicalnote}
This is the clean mathematical version of the usual intuition that attention forms a weighted average over candidate pieces of context. The output cannot jump outside the convex hull of the values being mixed; what changes is which values receive most of the weight.
\end{practicalnote}
