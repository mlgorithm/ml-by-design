...
\begin{figure}[t]
\centering
\includegraphics[width=0.66\linewidth,alt={Syntax tree for the sentence Colorless green ideas sleep furiously, showing phrase structure beyond word counts.}]{figures/external/syntax_tree_clean.png}
