...
\item For the loss \(L(w)=(w-3)^2\) with initial value \(w_0=0\), compute three update steps with learning rates \(\eta = 0.01\), \(\eta = 0.5\), and \(\eta = 1.5\). For which rate does the loss decrease fastest? For which does it diverge?
\end{exercises}
