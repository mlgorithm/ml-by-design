...
\begin{exercises}
\item \textbf{Learning rate by hand.}
Consider a one-dimensional loss $L(w) = (w - 3)^2$ with initial weight $w_0 = 0$.
...
\item \textbf{Reading a learning curve.}
A colleague shows you a plot where training loss decreases steadily, but validation loss stops improving at epoch~10 and then rises.
\begin{enumerate}[label=(\alph*)]
