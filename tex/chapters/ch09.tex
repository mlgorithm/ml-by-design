...
\begin{practicalnote}
Before training a graph neural network, always establish a non-relational baseline. Train a logistic regression or simple neural network on node features alone. If the graph model's improvement is small (e.g., 2--3\%), the gain may not justify the added complexity, debugging effort, and deployment risk. A significant improvement (10\%+) is stronger evidence that relational structure matters.
\end{practicalnote}
