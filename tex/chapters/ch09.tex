...
\item For a one-hour-ahead demand forecast, write one forbidden future feature and one allowed feature that might look superficially similar. Explain the difference in timing.
\item For a graph-based recommendation or molecular prediction task, state what relational information is available at prediction time and what non-relational baseline you would use.
