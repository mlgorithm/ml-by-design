...
def make_lagged_dataset(series, lag_count=24):
    ...
    targets = []
    times = []
    for index in range(lag_count, len(series) - 1):
        features.append(series[index - lag_count : index])
...
def main():
    ...
    chronological_model = LinearRegression()
    ...
    print()
    print("Evaluation")
    print(f"  random_split_linear_regression_rmse={random_rmse:.3f}")
    print(f"  chronological_split_linear_regression_rmse={chronological_rmse:.3f}")
